...
router.post('/offers/backgrounds/admin', verifyAdminToken, createOfferBackground);
router.patch('/offers/backgrounds/:backgroundId', verifyAdminToken, updateOfferBackground);
router.patch('/offers/backgrounds/admin/:backgroundId', verifyAdminToken, updateOfferBackground);
router.delete('/offers/backgrounds/:backgroundId', verifyAdminToken, deleteOfferBackground);
router.delete('/offers/backgrounds/admin/:backgroundId', verifyAdminToken, deleteOfferBackground);
