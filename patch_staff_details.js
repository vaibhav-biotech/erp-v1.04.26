...
const file = path.join(__dirname, 'frontend', 'src', 'app', 'admin', 'dashboard', 'super-admin', 'manage-staff', '[id]', 'page.tsx');
let content = fs.readFileSync(file, 'utf8');

// Replace everything starting from the imports down to the return
// Actually it's easier to just overwrite the entire file with a clean implementation.
...
console.log('Successfully replaced file with new UI');
